...
namespace SelectString
{
    ...
    {
        Dictionary<string, long> ThrottleTimes = new Dictionary<string, long>();
        delegate void ReceiveEventDelegate(IntPtr addon, EventType evt, uint a3, IntPtr a4, IntPtr a5);

        internal void ClickItemThrottled(IntPtr addonPtr, int index, string identifier)
        {
            ...
            ClickItem(addonPtr, index);
        }

        void ClickItem(IntPtr addonPtr, int index)
        {
        ...
        void SendClick(IntPtr arg1, EventType arg2, uint arg3, void* target) => SendClick(arg1, arg2, arg3, target, IntPtr.Zero);

        void SendClick(IntPtr arg1, EventType arg2, uint arg3, void* target, IntPtr arg5)
        {
        ...
        unsafe ReceiveEventDelegate GetReceiveEventDelegate(AtkEventListener* eventListener)
        {
